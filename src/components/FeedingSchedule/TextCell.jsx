 ...
 */
export default function TextCell({ value, onChange, placeholder, className, onFocus }) {
  const title = "Enter a time as HH:MM (e.g., 07:30, 20:00) or type a note like ‘On Holiday’.";
  ...
  return (
    <div className={`flex items-stretch gap-1 ${className || ''}`}>      
      <input
        ...
        autoCapitalize="off"
        spellCheck={false}
        onInvalid={(e) => e.target.setCustomValidity("Use HH:MM (e.g., 07:30) or ‘On Holiday’")}
